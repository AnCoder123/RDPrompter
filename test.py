...
parser.add_argument('--className', default='', type=str)
...
if __name__ == '__main__':
    ...
    (FBIoU, _),(_, mIoU)  =runner.test(task_name=args.task_name,className=args.className)
    print("FBIoU"+str(FBIoU)) 
    print("FmIoU"+str(mIoU))